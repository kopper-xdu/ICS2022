...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */)               \
	...
	INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall, R, s->dnpc = isa_raise_intr(R(11), s->pc));

	// RV32/RV64 Zifencei Standard Extension
	// INSTPAT("0000000 00000 00000 001 00000 00011 11", fence.i, I, R(dest) = imm);

	// RV32/RV64 Zicsr Standard Extension
	// INSTPAT("??????? ????? ????? 001 ????? 11100 11", csrrw, I, R(rd) = R(BITS(src1, 31, 0)) = imm);
